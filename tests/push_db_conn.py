...
def remove_conn():
    #Removing connection
    remove_conn_data = {
        "removed":["postgresql://push/test_host/push_test"]
    }
...
def add_table():
    ...
    table_update_data = {
        "updated_tables": [{
            "name": {"table_name": "Album", "schema_name": "PUBLIC", "database_name": "push_test"},
            "columns": [
                {"name": "AlbumId", "type": "integer", "comment": None, "sample_values": None, "description": "Unique identifier for the album.", "description_update_source": "generated"},
                {"name": "Title", "type": "character varying", "comment": None, "sample_values": None, "description": "Title of the album.", "description_update_source": "generated"},
                {"name": "ArtistId", "type": "integer", "comment": None, "sample_values": None, "description": "Identifier for the artist of the album.", "description_update_source": "generated"}
            ],
            "comment": None,
            "last_altered_time": 0,
            "refs": None,
            "constraints": [
                {"source": "database", "table": {"table_name": "Artist", "schema_name": "PUBLIC", "database_name": "push_test"}, "cols": ["ArtistId"], "constraint_type": None, "src_table": {"table_name": "Album", "schema_name": "PUBLIC", "database_name": "push_test"}, "src_cols": ["ArtistId"], "comment": None}
            ],
            "inferred_refs": [],
    ...
    updating_table_response = requests.post(update_table_endpoint, json = table_update_data)
