...
def load_db_conn1():
    ...
    db_connection = DBConnection(
        key=f"postgresql://waii@localhost:{port}/waii_sdk_test",  # will be generated by the system
        db_type="postgresql",
        host="localhost",
        port=port,
...
def load_db_conn2():
    port = constants.pg_port
    db_connection = DBConnection(
        key=f"postgresql://waii@localhost:{port}/waii_sdk_test2",  # will be generated by the system
        db_type="postgresql",
        host="localhost",
        port=port,
